<template>
  ...
  <div class="btn-group btn-group-vertical"> 
     <!-- somehow it isnt work as vertical -->
    <button @click="gameSch = false" class="btn" :class="!gameSch ? ' btn btn-active' : 'btn'">Week</button>
    <button @click="gameSch = true" class="btn" :class="gameSch ? 'btn-active' : 'btn'">Game</button>
  </div>
